        ...
        if (isFormValid) {
            ...
            .then(function() {
                ...
                if (successMessage) {
                    ...
                    tempSuccess.textContent = 'Form submitted successfully!';
            ...
            .catch(function() {
                const errorMessage = form.querySelector('.form-global-error');
                if (errorMessage) {
                    errorMessage.style.display = 'block';
                } else {
                    const tempError = document.createElement('div');
                    tempError.className = 'form-global-error';
                    tempError.textContent = 'An error occurred. Please try again.';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1687a7a6-0665-48c1-be60-9b4e1170d944',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1687a7a6-0665-48c1-be60-9b4e1170d944';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1687a7a6-0665-48c1-be60-9b4e1170d944';
